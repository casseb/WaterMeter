package br.com.simnetwork.model.files;
...
public final class CreateAppUser {
	...
	private static final String APP_USER_NAME = access.getBoxUsername();
    ...
    public static void main(String[] args) throws IOException {
        ...
        Reader reader = new FileReader("src/main/java/access/boxConfig.json");
